<template>
	<footer
		class="w-full border-t border-1 border-dashed p-5 dark:border-gray-600"
	>
		<div class="flex max-w-7xl mx-auto justify-between items-center">
			<p>© jotapbatista {{ new Date().getFullYear() }}</p>

			<div
				id="social"
				class="flex items-center dark:text-gray-200 text-gray-700"
			>
				<NuxtLink>
