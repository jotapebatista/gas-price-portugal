<template>
  <div class="fixed bottom-0 left-0 right-0 z-[1000] bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 shadow-lg">
    <div class="flex items-center justify-around px-2 py-2">
      ...
      <button
        @click="activeTab = 'map'"
        class="flex flex-col items-center justify-center px-4 py-2 rounded-lg transition-all duration-200"
        :class="activeTab === 'map' 
      ...
      <button
        ...
        class="flex flex-col items-center justify-center px-4 py-2 rounded-lg transition-all duration-200 relative"
        :class="activeTab === 'filters' 
          ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20' 
          : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200'"
      >
        <Icon name="heroicons:funnel" class="w-6 h-6 mb-1" />
      ...
      <button
        ...
        :class="activeTab === 'results' 
          ...
          : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200'"
      >
        <Icon name="heroicons:document-text" class="w-6 h-6 mb-1" />
      ...
      <button
        ...
        :class="activeTab === 'settings' 
          ...
          : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200'"
      >
        <Icon name="heroicons:cog-6-tooth" class="w-6 h-6 mb-1" />
